...
namespace TimeTaggerClient.Interfaces
{
    ...
    interface ITimeTaggerClient
    {
        ...
        Task<IEnumerable<TimeTaggerRecord>> FetchRecords( DateTime? start = null, DateTime? end = null );

        /// <summary>
        /// Fetches TimeTagger settings.
        /// </summary>
        /// <returns>A list of all TimeTagger settings.</returns>
        Task<IEnumerable<TimeTaggerSetting>> FetchSettings();
        ...
        Task<(DateTime ServerTime, IEnumerable<TimeTaggerRecord> Records, IEnumerable<TimeTaggerSetting> Settings)> FetchNew( DateTime since );
        ...
        Task<(IEnumerable<string> AcceptedKeys, IEnumerable<string> RejectedKeys, IEnumerable<string> Errors)> UpdateRecords( IEnumerable<TimeTaggerRecord> records );
        ...
        /// <returns>A tuple containing an enumerable list of accepted keys, rejected keys, and any errors that may have occurred (one per rejected key + optionally other errors).</returns>
        Task<(IEnumerable<string> AcceptedKeys, IEnumerable<string> RejectedKeys, IEnumerable<string> Errors)> DeleteRecords( IEnumerable<TimeTaggerRecord> records );
        ...
        /// <returns>A tuple containing an enumerable list of accepted keys, rejected keys, and any errors that may have occurred (one per rejected key + optionally other errors).</returns>
        Task<(IEnumerable<string> AcceptedKeys, IEnumerable<string> RejectedKeys, IEnumerable<string> Errors)> UpdateSettings( IEnumerable<TimeTaggerSetting> settings );
    }
}
